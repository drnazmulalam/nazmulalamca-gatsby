...
import { FaMoon, FaTwitter, FaTimes, FaLinkedin } from "react-icons/fa"
    ...
    <header className={`top__header ${headerStyles.container}`}>
      ...
      <div className={headerStyles.headerContentWrap}>
          ...
          <div className={headerStyles.content}>
            <div className={headerStyles.brand}>
              <Link to="/" className={headerStyles.brandLink}>
                <img src={logo} alt="Nazmul alam logo" title="site logo" />
              </Link>
            </div>
        ...
        <div className={`content__right ${headerStyles.contentRight}`}>
          <a
            href={`https://www.linkedin.com//${data.site.siteMetadata.linkedin}`}
            target="_blank"
